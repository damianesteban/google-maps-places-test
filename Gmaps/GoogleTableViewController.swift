...
class GoogleTableViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        let placesURL = NSURL(string: "https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=40.7275043,-73.9800645&radius=5000&types=\(type)&key=\(key)")
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        cell.detailTextLabel!.text = repositories[indexPath.row].address
